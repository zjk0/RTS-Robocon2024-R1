...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM5_MspPostInit 0 */
    ...
    PH10     ------> TIM5_CH1
    */
    GPIO_InitStruct.Pin = qu_qiu_duoji_A_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM5;
    HAL_GPIO_Init(qu_qiu_duoji_A_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = fa_she_qiu_duoji_B_Pin|qumiao_jiazi_duoji2_C_Pin|qumiao_jiazi_duoji1_D_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM5;
  ...
  /* USER CODE END TIM8_MspPostInit 0 */
    ...
    PI6     ------> TIM8_CH2
    */
    GPIO_InitStruct.Pin = jiguang_duoji_2_Y_Pin|jiguang_duoji_1_X_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
