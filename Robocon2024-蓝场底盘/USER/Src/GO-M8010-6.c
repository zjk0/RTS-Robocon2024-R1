...
//		SATURATE(motor_s->mode, 0,    7);
    ...
    motor_s->motor_send_data.comd.k_pos  = (int16_t)(motor_s->K_P/25.6f*32768);
    motor_s->motor_send_data.comd.k_spd  = (int16_t)(motor_s->K_W/25.6f*32768);
    motor_s->motor_send_data.comd.pos_des  = (int16_t)(motor_s->Pos/6.2832f*32768);
    motor_s->motor_send_data.comd.spd_des  = (int16_t)(motor_s->W/6.2832f*256);
