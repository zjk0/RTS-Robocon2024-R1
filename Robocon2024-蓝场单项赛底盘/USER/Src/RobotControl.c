...
//#define Speed_Limit_x_Far 3 
//#define Speed_Limit_x_Close 2.5 
//#define Speed_Limit_y_Far 3 
//#define Speed_Limit_y_Close 2.5 

//#define MAX_SPEED_Area2_x_Far 1.8
//#define MAX_SPEED_Area2_x_Close 1.8
//#define MAX_SPEED_Area2_y_Far 1.8
//#define MAX_SPEED_Area2_y_Close 1.8

#define MAX_SPEED_Area2_x_Far 1.8
#define MAX_SPEED_Area2_x_Close 1.6
#define MAX_SPEED_Area2_y_Far 1.8
...
#define KP_x_Far 3
#define KP_x_Close 4//1.7 + 0.05 + 0.3
#define KP_y_Far 3
#define KP_y_Close 4//1.6 + 0.05 + 0.3
...
//PIDType PID_Vx_move_distance = {2.5, 0.00025, 0.22, 0, 0, 0, 0, 0, 1.3};
//PIDType PID_Vy_move_distance = {2.5, 0.00001, 0.22, 0, 0, 0, 0, 0, 1.3}; // {2.5, 0.00025, 0.2, 0, 0, 0, 0, 0, 1.3}
//PIDType PID_w_move_distance = {1.6, 0.0002, 0.1, 0, 0, 0, 0, 0, 1.5};    // 最后一个是w的限幅

//PIDType PID_Vx_move_distance = {2.5, 0.00005, 2.2, 0, 0, 0, 0, 0, 1.3};
//PIDType PID_Vy_move_distance = {2.5, 0.00005, 10, 0, 0, 0, 0, 0, 1.3}; // {2.5, 0.00025, 0.2, 0, 0, 0, 0, 0, 1.3}
//PIDType PID_w_move_distance = {1.6, 0.0002, 0.2, 0, 0, 0, 0, 0, 1.5};    // 最后一个是w的限幅

PIDType PID_Vx_move_distance = {2.5, 0, 2.2, 0, 0, 0, 0, 0, 1.3};
...
{                                 
    ...
    if (distance_w - Robot.Robot_in_self.position_now.yaw >= -0.018 && distance_w - Robot.Robot_in_self.position_now.yaw <= 0.018)
    {
...
//	Robot.Robot_in_world.velocity_exp.Vx = 0;
	jishu_0_x = 10000;
//    if (Robot.Robot_in_self.position_now.x - position_x >= -0.015 && Robot.Robot_in_self.position_now.x - position_x <= 0.015) {
//        PID_Vx_move_distance.SumErr = 0;
//		PID_Vx_move_distance.Sumlimit = 0.3;
//        Robot.Robot_in_world.velocity_exp.Vx = 0;
//        //jishu_0_x++;
...
//        PID_Vx_move_distance.KP = 1;
//        //PID_Vx_move_distance.KI = /*0.00012*/ 0.000145;
//        //PID_Vx_move_distance.KD = 0.2298;
//        Robot.Robot_in_world.velocity_exp.Vx = PIDCal_pos(&PID_Vx_move_distance, -(Robot.Robot_in_self.position_now.x - position_x));
//    }
...
void PID_Vx_Laser_area2 (float position_x, float position_y, float position_w) {
	...
	jishu_0_y = 10000;
	PID_w_move_distance.KP = 3;
//    if (Robot.Robot_in_self.position_now.y - position_y >= -0.01 && Robot.Robot_in_self.position_now.y - position_y <= 0.01) {
//        PID_Vy_move_distance.SumErr = 0;
//		PID_Vy_move_distance.Sumlimit = 0.3;
//        Robot.Robot_in_world.velocity_exp.Vy = 0;
//        //jishu_0_y++;
...
//        jishu_0_y = 0;
//        PID_Vy_move_distance.Sumlimit = MAX_SPEED_Area2_y_Close;
//        PID_Vy_move_distance.KP = 1;
//        //PID_Vy_move_distance.KI = 0;
//        //PID_Vy_move_distance.KD = 0.00108;
//        Robot.Robot_in_world.velocity_exp.Vy = PIDCal_pos(&PID_Vy_move_distance, position_y - Robot.Robot_in_self.position_now.y);
//    }
