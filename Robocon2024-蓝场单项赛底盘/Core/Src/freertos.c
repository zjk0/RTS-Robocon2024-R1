...
void StartDefaultTask(void *argument)
{
    ...
    pos_ball_x[2][2] = 1.23705136 - 0.02;
...
void SBUSTask(void *argument)
{
    ...
    for (;;)
    {
        ...
        if (laser_status == 4 || laser_status == 8 || laser_status == 12 || laser_status == 16 || laser_status == 20 || (laser_status == 23 && SBUS_Analyse_Switch(SBUS.CH13) == 0))
        {
            if (jishu_0_x >= 1 && jishu_0_y >= 1 /* && jishu_0_w >= 1*/)
            {
                ...
                if (laser_status <= 23)
                {
                    ...
                    if (laser_status == 2 || laser_status == 6 || laser_status == 10 || laser_status == 14 || laser_status == 18)
                    {
                        osDelay(1200);
                    }
                    move_flag_laser = 1;
...
void PositionTask(void *argument)
{
    ...
    for (;;)
    {
        if (move_flag_laser)
        {
            ...
            else if (laser_status == 2) // release first seed
            {
                Move_Distance_Laser(2.9233024122, 1.41548478, 0);
                Release_Seed_Flag = 1;
            }
            else if (laser_status == 3) //
            {
                Robot.Robot_in_world.velocity_exp.Vy = 0.7;
                Robot.Robot_in_world.velocity_exp.Vx = -0.7;
                osDelay(400);
                laser_status++;
                Enable_flag = 1;
                Robot.Robot_in_world.velocity_exp.Vy = 0;
            ...
            else if (laser_status == 4) // in front of seed
            {
                Move_Distance_Laser(2.6598193644, 3.4714949133, 0);
            ...
            else if (laser_status == 5) // catch the seed
            {
                Release_Seed_Flag = 0;
                Robot.Robot_in_world.velocity_exp.Vy = -0.5;
                Robot.Robot_in_world.velocity_exp.Vx = 0;
            ...
            else if (laser_status == 6) // release the second seed
            {
                Move_Distance_Laser(2.42761492, 1.40046524, 0);
                Release_Seed_Flag = 1;
            }
            else if (laser_status == 7) // back
            {
                Robot.Robot_in_world.velocity_exp.Vy = 0.7;
                Robot.Robot_in_world.velocity_exp.Vx = -0.7;
                osDelay(400);
            ...
            else if (laser_status == 8) // in the front of seed
            {
                Move_Distance_Laser(2.17844581, 3.5407648, 0);
                if (Enable_flag == 1) // ��ֻ֤��һ��
                {
                    HAL_UART_Transmit(&huart6, Enable_Command, 1, 1000);
                    Enable_flag = 0;
            ...
            else if (laser_status == 9) // catch seed
            {
                Release_Seed_Flag = 0;
                Robot.Robot_in_world.velocity_exp.Vy = -0.5;
                Robot.Robot_in_world.velocity_exp.Vx = 0;
            ...
            else if (laser_status == 10) // release the third seed
            {
                Move_Distance_Laser(1.91814351, 1.40046524, 0);
                Release_Seed_Flag = 1;
            }
            else if (laser_status == 11) // back
            {
                Robot.Robot_in_world.velocity_exp.Vy = 0.7;
                Robot.Robot_in_world.velocity_exp.Vx = -0.7;
                osDelay(400);
            ...
            else if (laser_status == 12) // in the front of seed
            {
                Move_Distance_Laser(1.68646931, 3.5407648, 0);
                if (Enable_flag == 1) // ��ֻ֤��һ��
                {
                    HAL_UART_Transmit(&huart6, Enable_Command, 1, 1000);
                    Enable_flag = 0;
            ...
            else if (laser_status == 13) // catch the seed
            {
                Release_Seed_Flag = 0;
                Robot.Robot_in_world.velocity_exp.Vy = -0.5;
                Robot.Robot_in_world.velocity_exp.Vx = 0;
            ...
            else if (laser_status == 14) // release fourth seed
            {
                Move_Distance_Laser(1.41185307, 1.40046524, 0);
                Release_Seed_Flag = 1;
            }
            else if (laser_status == 15) // back
            {
                Robot.Robot_in_world.velocity_exp.Vy = 0.7;
                Robot.Robot_in_world.velocity_exp.Vx = -0.7;
                osDelay(400);
            ...
            else if (laser_status == 16) // in front of the seed
            {
                Move_Distance_Laser(1.17858839, 3.5407648, 0);
                if (Enable_flag == 1) // ��ֻ֤��һ��
                {
                    HAL_UART_Transmit(&huart6, Enable_Command, 1, 1000);
                    Enable_flag = 0;
            ...
            else if (laser_status == 17) // catch seed
            {
                Release_Seed_Flag = 0;
                Robot.Robot_in_world.velocity_exp.Vy = -0.5;
                Robot.Robot_in_world.velocity_exp.Vx = 0;
            ...
            else if (laser_status == 18) // release fifth seed
            {
                Move_Distance_Laser(0.91086405511, 1.40046524, 0);
                Release_Seed_Flag = 1;
            }
            else if (laser_status == 19) // ���Ҳ�Ҫ��̫��
            {
                Release_Seed_Flag = 0;
            ...
            {
                Move_Distance_Laser(3.89188122 + 0.09768, 1, 0);
            }
...
void IOTask(void *argument)
{
    ...
    for (;;)
    {
        if (laser_status > 23 && SBUS_Analyse_Switch(SBUS.CH12) == 2)
        {
